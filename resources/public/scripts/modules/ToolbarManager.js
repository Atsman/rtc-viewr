...
function ToolbarManager(window, toolbar, controls) {
  this.window_ = window;
...
ToolbarManager.prototype = {
  ...
  showToolbars: function() {
    if(this.toolbar_) {
      /*this.toolbar_.show();*/
      this.toolbar_.addClass('active');
      this.controls_.addClass('active');
    }
  },
  ...
  hideToolbarsIfAllowed: function() {
    ...
    if(this.toolbar_) {
      /*this.toolbar_.hide();*/
      this.toolbar_.removeClass('active');
      this.controls_.removeClass('active');
    }
  },
